...
protected:
    ...
    int sum_vaccine_c2 = 0; //these are centers
...
void covid_management::menu()
{
    ...
    case 3:
        system("cls");
        cout << "\n\n\t\t\t SUMMER TRAINING COVID-19 MANAGMENT SYSTEM  DEVELOPER TRILOKI";
        Sleep(10);
        exit(0);
    default:
...
void covid_management::admin_password()
{
    ...
    cout << "\n\n\t\tEnter Valid Captcha: ";
    cin >> capta;
    if ((strcmp(a_name, "triloki") == 0) && (strcmp(a_password, "aptinstall") == 0) && (capt == capta))
    {
        cout << "\n\n\n\t\t\t\t\t| Verfiying ADMIN |\n\t\t\t\t\t";
        for (int a = 1; a < 8; a++)
        {
